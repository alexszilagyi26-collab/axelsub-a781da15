            ...
            <div className="flex gap-3 md:gap-4">
              {isLoading
                ? Array.from({ length: 8 }).map((_, i) => (
                    <div key={i} className="flex-shrink-0 w-32 sm:w-40 md:w-44 2xl:w-56">
                ...
                : animes?.map((anime, index) => (
                    <motion.div
                      key={anime.id}
                      className="flex-shrink-0 w-32 sm:w-40 md:w-44 2xl:w-56"
              ...
              {!isLoading && animes && animes.length > 0 && (
                <div className="flex-shrink-0 w-32 sm:w-40 md:w-44 2xl:w-56">
                  <Link to={viewAllLink}>
