...
const AnimeDetail = () => {
  ...
  const playerProps = {
    ...
    thumbnailUrl: selectedEpisode?.thumbnail_url || undefined,
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 pb-24 md:pb-0">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 py-8 pb-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              {/* Poster */}
              <div className="flex-shrink-0 w-32 sm:w-40 md:w-56 lg:w-64 mx-auto md:mx-0">
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          {/* Player */}
          <div className="rounded-xl overflow-hidden border border-border/30 shadow-2xl shadow-primary/5 mb-3 aspect-video">
            {isPlaying && (selectedEpisode?.video_url || anime.video_url) ? (
              ...
              <div
                className="w-full h-full flex items-center justify-center bg-muted/30 cursor-pointer group"
                onClick={() => {
          ...
          {selectedEpisode && (
            <div className="flex items-center justify-between gap-2 mb-4 px-1">
              ...
              <span className="sm:hidden text-sm font-medium text-foreground truncate">
                {selectedEpisode.episode_number}. rész
                {selectedEpisode.title ? ` – ${selectedEpisode.title}` : ""}
              </span>
              <div className="flex gap-2 shrink-0">
                <Button
                  variant="outline"
                  size="sm"
                  className="gap-1 min-w-[80px] touch-manipulation"
          ...
          <div className="rounded-xl border border-border/30 bg-card/50 p-4">
            <EpisodeList
              ...
              selectedEpisodeId={isPlaying ? selectedEpisode?.id : undefined}
